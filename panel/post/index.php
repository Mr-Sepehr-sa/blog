            ...
            <section class="col-md-10 pt-3">
                ...
                <section class="table-responsive">
                    <table class="table table-striped table-">
                        ...
                        <?php
                        global $pdo;
                        $query = "SELECT php_project.posts.*,php_project.categories.name AS category_name FROM php_project.posts LEFT JOIN 
                            php_project.categories ON php_project.posts.cat_id = php_project.categories.id";
                        ...
                        foreach ($posts as $post){?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= url('panel/post/change_status.php?post_id=').$post->id ?>" class="btn btn-warning btn-sm">Change status</a>
